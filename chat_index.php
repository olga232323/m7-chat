...
if (!isset($_SESSION['loginOk'])) {
  ...
  <head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
      ...
      <script src="./js/funcion_eviar.js"></script>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-7 col-xl-8">
                    ...
                    <div class="pt-3 pe-3" data-mdb-perfect-scrollbar="true" style="position: relative; height: 400px">
                      ...
                      if (!isset($_SESSION["leerMensajes"])) {
                        ?>
                        <div class='d-flex flex-row justify-content-center align-items-center '>
                          <div>
                            <p class='small p-2 ms-3 mb-1 rounded-3' style='background-color: #f5f6f7;'>Selecciona una persona para chatear!</p>
                          </div>
                        </div>
                        <?php
                      } else {
