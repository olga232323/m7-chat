...
// // {
    ...
    try {
        ...
        // SELECT u.user_id, u.nombre_real, a.estado_solicitud FROM usuarios u inner join amistades a where u.user_id = a.user_id_1 and (u.username LIKE :parametro OR u.nombre_real LIKE :parametro) AND u.user_id <> :userID; 
        // <> not equal !=
